        ...
        <div class="text-village">
          <div class="text_vill">
            ...
            <p class="text_v">
              ...
              เข้าและพอถึงหน้าแล้งน้ำแห้งลงก็ทำให้เกิดที่ราบซึ่งชาวบ้านเรียกว่า หาด แต่สำหรับคำว่า เบี้ยนั้นหมายถึง
              วัตถุชนิดหนึ่งมีรูปร่างคล้ายหอยชนิดหนึ่ง
            </p>
            <h1 class=" mt-3 text_h1">ความหมายของชื่อหมู่บ้าน</h1>
            <p class="text_v">
            หาด+เบี้ย หาด หมายถึง ที่ที่เป็นดินราบ
            เป็นวงกว้างและยาวตามลำน้ำโขงเป็นที่ราบที่เกิดจากกระแสน้ำพัดมาทับทมกันนานๆ
            เข้าและพอถึงหน้าแล้งน้ำแห้งลงก็ทำให้เกิดที่ราบซึ่งชาวบ้านเรียกว่า หาด แต่สำหรับคำว่า เบี้ยนั้นหมายถึง
            วัตถุชนิดหนึ่งมีรูปร่างคล้ายหอยชนิดหนึ่ง ซึ่งคนโบราณนำมานับแทนจำนวนเงิน
            ซึ่งคนสมัยก่อนนั้นคิดเลขไม่เป็นต้องใช้ก้อนหินหรือวัตถุอย่างใดอย่างหนึ่งมานับแทนเช่น ลูกเบี้ย ดังนี้
            สมัยก่อนใช้เปลือกหอยเบี้ยเป็นเครื่องแลกเปลี่ยนแทนเงิน อัตรา 100 เบี้ยเป็น 1 อัฐ(สตางค์)

            บ้านหาดเบี้ย ก่อตั้งเมื่อปี พ.ศ. 2516
            ได้จากคำบอกเล่าว่าแต่ก่อนนั้นมีพวกพ่อค้าเดินเรือสินค้าเรือแจวจากจังหวัดหนองคายจะนำเอาสินค้าไปจำหน่ายตามหมู่บ้านริมลำน้ำโขงและจุดมุ่งหมายปลายทางคือหลวงพระบาง
            พอมาถึงหมู่บ้านหาดเบี้ยก็พากันหยุดพัก เพราะตรงหมู่บ้านหาดเบี้ยเป็นแก่งน้ำไหลเชี่ยว
            พายเรือขึ้นไม่ได้จะต้องรอพวกเรือสินค้าด้วยกันขึ้นมาสมทบช่วย ประวัติมีสามีภรรยาคู่หนึ่งได้มาประกอบอาชีพ
            ทำไร่ – ทำสวน ในขณะนั้นพื้นที่หมู่บ้านมีความอุดมสมบูรณ์ทั้งในด้านทรัพยากรต่างๆ เช่นป่าไม้
            ข้อพิเศษของที่หมู่บ้านนี้คือตามชายหาดแม่น้ำโขงมีหินเบี้ยเป็นจำนวนมาก ต่อมามีญาติพี่น้องของสามี
            ภรรยาตามมาอาศัยอยู่ด้วยเพิ่มขึ้นเรื่อยๆ จนได้ตั้งหมู่บ้านขึ้น โดยใช้ชื่อว่า “บ้านหาดเบี้ย” มาจนทุกวันนี้
            </p>
            <h1 class=" mt-3  text_h1">ลักษณะที่ตั้งของหมู่บ้าน</h1>
            <p class="text_v">บ้านหาดเบี้ย ขึ้นอยู่กับตำบลปากชม หมู่ที่ 7 ตั้งอยู่ทางทิศตะวันตกของอำเภอปากชม ระยะห่างจากอำเภอ10
              กิโลเมตร</p>
